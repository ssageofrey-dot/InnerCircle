...
document.addEventListener("DOMContentLoaded", () => {
    ...
    window.addEventListener("scroll", () => {
        ...
        if (window.scrollY > 60) {
            ...
            header.style.background = "#081528";
    ...
    if (joinBtn) {
        ...
        joinBtn.addEventListener("click", () => {
            ...
            alert("Welcome to the Inner Circle Men's Savings Platform.");
        ...
        if (position < window.innerHeight - 100) {
            ...
            counters.forEach(counter => {
                ...
                const timer = setInterval(() => {
                    ...
                    counter.innerText = text.includes("%")
                        ? start + "%"
                        : text.includes("UGX")
                        ? "UGX " + (start * 1000).toLocaleString()
                        : start;
    ...
    document.querySelectorAll(".feature-card, .about-text, .about-image, .stat-box").forEach(el => {
